	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <label id=med >Medicine Name</label>
			...
			if(jsonData.message!=null)
				{
					...
					row.innerHTML="<td>"+details[0]+"</td><td>"+details[1]+"</td><td>"+details[2]+"</td><td><button class=\"btn btn-danger btn-sm\" onclick=\"sendInstructions('"+details[0]+","+details[2]+"','ambulance')\">Summon Ambulance</button><button type=\"button\" class=\"btn btn-primary btn-sm\" onclick=\"sendInstructions('"+details[0]+"','medication')\">Suggest Medication</button></td>";
				}
		}
		function sendInstructions(username,message)
		{
			if(message=='medication')
			{
				...
				document.getElementById("submit_btn").addEventListener("click",function(){
					...
					websocket.send(username+','+medicine+','+message+','+description);
					medicine_name.value="";
